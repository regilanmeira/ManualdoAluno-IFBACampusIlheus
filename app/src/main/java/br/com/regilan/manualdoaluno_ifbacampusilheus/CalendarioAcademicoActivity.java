...
public class CalendarioAcademicoActivity extends AppCompatActivity {
    ...
    AdapterView.OnItemClickListener selecionarItem = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, final int position, long id) {
            AlertDialog.Builder dialogo = new AlertDialog.Builder(CalendarioAcademicoActivity.this);
            ...
            dialogo.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    ...
                    switch (lvModalidade.getItemAtPosition(position).toString()) {
                        case "Integrado":
                            browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.regilan.com.br/app_ifba/calendario_integrado.pdf"));
                            break;
                        case "Subsequente":
                            browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("http://www.regilan.com.br/app_ifba/calendario_subsequente.pdf"));
                            break;
